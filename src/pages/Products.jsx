    ...
    <div className='container mx-auto flex flex-col gap-8'>
      ...
      <>
        <Swiper
          ...
          mousewheel
          keyboard
          className="mySwiper h-[80vh]  mt-10" // Добавил отступ сверху
        >
      ...
      <p className='font-bold text-center text-[30px] mt-5'>Mahsulotlar ro'yxati</p>
      <div className='grid grid-cols-3 gap-3'>
        {Array.isArray(data) && data.length > 0 ? (
          data.map((item) => (
            <div className='border border-gray-300 rounded-md shadow-lg overflow-hidden ' key={item.id}>
          ...
          <p>Mahsulotlar mavjud emas yoki yuklanmoqda...</p>
        )}
      </div>
